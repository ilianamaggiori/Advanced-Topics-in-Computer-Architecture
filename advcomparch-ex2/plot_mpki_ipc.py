...
## For nbit predictors, add other predictors as needed
predictors_to_plot = ["Nbit-16K-1" "2bit-16K-2" "Nbit-16K-2" "Nbit-16K-3" "Nbit-16K-4"]
...
plt.title("MPKI")
plt.savefig(input("MPKI_output.png): "),bbox_inches="tight")
