...
PIN_TOOL=/home/iliana/Downloads/advcomparch-ex2-helpcode/pintool/obj-intel64/cslab_branch.so
outDir="/home/iliana/Downloads/advcomparch-ex2-helpcode/outputs_4.2b"
...
for BENCH in "${benchmarks[@]}"; do
	...
	pinOutFile="$outDir/${BENCH}.cslab_4_2b_branch_predictors.out"
