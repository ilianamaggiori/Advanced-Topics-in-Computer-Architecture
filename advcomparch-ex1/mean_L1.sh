...
#  
Outputs="/home/iliana/Downloads/parsec-3.0/parsec_workspace/outputs"
results="/home/iliana/Downloads/parsec-3.0/parsec_workspace/l1_mean_results"
# List of configurations
CONFS=(32_4_32 32_4_64 32_4_128 32_8_32 32_8_64 32_8_128 64_4_64 64_8_32 64_8_64 64_8_128 128_8_32 128_8_64 128_8_128)
...
for conf in "${CONFS[@]}"; do
    ...
    pattern="L1_$(printf "%04d" "$L1_cache_size")_$(printf "%02d" "$L1_associativity")_$(printf "%03d" "$L1_block_size").out"
